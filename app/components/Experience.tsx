...
const experiences = [
    ...
    },
    {
      ...
      subtitle: "Fragniere Assureur-conseil",
      year: "Avril 2024",
...
export default function Experience() {
    ...
    const handleNext = () => {
        if (currentIndex + 2 < experiences.length) {
        ...
        <section className={styles.experience}>
            ...
            <div className={styles.container}>
                <div className={styles.controls}>
                    ...
                    <span>{currentIndex + 1} - {experiences.length - 1}</span>
                    <button onClick={handleNext} disabled={currentIndex + 2 >= experiences.length}><FontAwesomeIcon icon={faChevronRight} /></button>
                </div>
